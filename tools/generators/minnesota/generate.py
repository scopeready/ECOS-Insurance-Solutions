...
def footer():
  ...
  <div class="wrap">
    ...
    <div class="disclaimer">
      ...
      <p>Insurance products are offered through {ORG}. Darin Weidauer is a licensed insurance agent in Minnesota (NPN {NPN}{LIC_TXT}) and 15 other states. We may receive compensation from insurance carriers for policies we sell; you pay the same premium whether you enroll through us, another agent, or the carrier directly.</p>
...
def hero(scene, eyebrow, h1, sub, crumb_items, form_id, form_title="Talk it through with Darin", primary_label=None, photo=None):
    ...
    if photo:
        ...
        enroll_note = f'No cost, no pressure. Prefer to call? <a href="tel:{TEL}"><strong>{PHONE}</strong></a>, or <a href="{QUOTE_URL}" target="_blank" rel="noopener">enroll yourself online</a>.'
...
## Agent / author
Darin Weidauer, MBA, RSSA — independent Medicare insurance agent licensed in Minnesota (NPN 18580338, MN License #40620754) and 15 other states (AZ, CA, CO, GA, HI, IN, HI, IN, MN, NC, NM, NV, OH, SC, TN, TX, UT, WA), credentialed gerontologist (since 2014), Registered Social Security Analyst, and 22-year U.S. Air Force veteran (retired officer). Author of "Retire With Confidence: Medicare, Social Security, and the Money Decisions That Decide Your Retirement" (2026 Edition, 295 pages). Former Professor of Aerospace Studies at Loyola Marymount University; has lectured at more than 50 colleges and universities. Canonical author profile: https://www.myecos360.com/darin-weidauer
""")
    for p in TOPIC_PAGES:
        full.append(f"\n## {unesc(p['h1'])}\nURL: {SITE_URL}/{p['slug']}\n")
