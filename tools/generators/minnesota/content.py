...
<h2>Licensing</h2>
<p>Darin is a licensed insurance agent in Minnesota and fifteen other states &mdash; Arizona, California, Colorado, Georgia, Hawaii, Indiana, Nevada, New Mexico, North Carolina, Ohio, South Carolina, Tennessee, Texas, Utah and Washington &mdash; under National Producer Number 18580338, which you can verify with the Minnesota Department of Commerce or the NIPR. The multi-state licence is what lets us follow Minnesota <a href="/snowbirds">snowbirds</a> to Arizona, Florida and Texas.</p>
