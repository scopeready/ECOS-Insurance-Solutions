...
def footer():
  ...
  <div class="wrap">
    ...
    <div class="disclaimer">
      ...
      <p>Insurance products are offered through {ORG}. {A_NAME} is a licensed insurance agent in {STATE} (NPN {A_NPN}{A_LIC_TXT}){" and 15 other states" if A_IS_DARIN else ""}. We may receive compensation from insurance carriers for policies we sell; you pay the same premium whether you enroll through us, another agent, or the carrier directly.</p>
...
def write_discovery():
    ...
    DARIN_FULL_TAIL = f" licensed in {STATE} (NPN {NPN}) and 15 other states" if A_IS_DARIN else f" and founder of {ORG} (NPN {NPN})"
